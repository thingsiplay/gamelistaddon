...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_3.setHorizontalSpacing(90)
        ...
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.cb_desc_settings_merge)
        spacerItem15 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.formLayout_3.setItem(3, QtWidgets.QFormLayout.LabelRole, spacerItem15)
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.cb_path_settings_merge)
        ...
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.cb_image_settings_merge)
        ...
        self.formLayout_3.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.cb_marquee_settings_merge)
        ...
        self.formLayout_3.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.cb_video_settings_merge)
        spacerItem16 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.formLayout_3.setItem(9, QtWidgets.QFormLayout.LabelRole, spacerItem16)
        ...
        self.formLayout_3.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.cb_lastplayed_settings_merge)
        ...
        self.formLayout_3.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.cb_playcount_settings_merge)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.cb_rating_settings_merge)
        ...
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.cb_genre_settings_merge)
        ...
        self.formLayout_3.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.cb_players_settings_merge)
        ...
        self.formLayout_3.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.cb_releasedate_settings_merge)
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.cb_developer_settings_merge)
        ...
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.cb_publisher_settings_merge)
        self.verticalLayout_2.addLayout(self.formLayout_3)
        spacerItem17 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.MinimumExpanding)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/Icons/img/replace.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_selecttoggle_settings_merge.setIcon(icon5)
