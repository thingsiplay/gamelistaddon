...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.b_selecttoggle_settings_merge = QtWidgets.QPushButton(self.tab_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.b_selecttoggle_settings_merge.sizePolicy().hasHeightForWidth())
        self.b_selecttoggle_settings_merge.setSizePolicy(sizePolicy)
        self.b_selecttoggle_settings_merge.setMinimumSize(QtCore.QSize(160, 45))
        self.b_selecttoggle_settings_merge.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Icons/img/replace.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_selecttoggle_settings_merge.setIcon(icon4)
        self.b_selecttoggle_settings_merge.setIconSize(QtCore.QSize(24, 24))
        self.b_selecttoggle_settings_merge.setObjectName("b_selecttoggle_settings_merge")
        self.horizontalLayout_4.addWidget(self.b_selecttoggle_settings_merge)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/Icons/img/reset.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_selectall_settings_merge.setIcon(icon5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b_selecttoggle_settings_merge.setText(_translate("MainWindow", " &Toggle All"))
